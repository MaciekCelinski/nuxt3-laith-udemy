<template>
  <div class="option-container">
    ...
    <div class="option-buttons">
      <button v-for="value, index in option.buttons" :key="index" class="option"
        :class="computedButtonClasses(value, index)" @click="options[option.category] = value">
        {{ value }}
      </button>
    </div>
  </div>
